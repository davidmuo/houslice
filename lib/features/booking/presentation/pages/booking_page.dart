                ...
                children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  // Price shrinks before the rating does, so
                                  // the row fits narrow screens.
                                  Flexible(
                                    child: Text(
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                form.hasValidRange
                                    ? Formatters.range(form.start!, form.end!)
                                    : 'Choose your dates',
                                style: textTheme.titleSmall?.copyWith(
                                  fontWeight: FontWeight.w700,
                                ),
                  ...
                  if (form.method == null) ...[
                    _PaymentOption(
                      ...
                      // Card requires details first; the Add Card screen
                      // returns the last four digits to label the method.
                      onTap: () async {
                        final cubit = context.read<BookingFormCubit>();
                        final last4 = await Navigator.of(
                          context,
                        ).pushNamed<String>(AppRoutes.addCard);
                        if (last4 != null) {
                    ...
                    onTap: () {
                      ScaffoldMessenger.of(context)
                        ...
                        ..showSnackBar(
                          const SnackBar(
                            content: Text(
                              'Vouchers are coming soon for students',
                            ),
                          ),
                        );
                    },
                  ...
                  BlocBuilder<BookingBloc, BookingState>(
                    ...
                    builder: (context, bookingState) => PrimaryButton(
                      ...
                      busy: bookingState.status == BookingViewStatus.creating,
