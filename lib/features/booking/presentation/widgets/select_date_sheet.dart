...
Future<void> showSelectDateSheet(BuildContext context, BookingFormCubit cubit) {
  return showModalBottomSheet<void>(
    ...
    builder: (sheetContext) =>
        BlocProvider.value(value: cubit, child: const _SelectDateSheet()),
  );
}
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    // Takes the width left by the icon so the caption can
                    // ellipsise instead of overflowing the sheet.
                    Expanded(
                      child: Column(
